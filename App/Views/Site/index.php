...
<html lang="en">
  ...
  <head>
    ...
    <link rel="icon" href="http://<?php echo APP_HOST; ?>/App/Views/Site/img/Logo.png">

    <!-- Bootstrap core CSS -->
    <link href="http://<?php echo APP_HOST; ?>/App/Views/Site/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="http://<?php echo APP_HOST; ?>/App/Views/Site/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="http://<?php echo APP_HOST; ?>/App/Views/Site/css/agency.min.css" rel="stylesheet">
    <link href="http://<?php echo APP_HOST; ?>/App/Views/Site/css/custumizacao.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container-fluid">
        <a  class="navbar-brand js-scroll-trigger" id="logo_navbar" href="#page-top">
        	<img src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/Logo.png" alt="logo" id="img_logo" />
        	Hass Soluções 
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="http://<?php echo APP_HOST; ?>/Usuario">Admin</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="row text-center">
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              ...
              <img class="img-fluid" alt="Responsive image" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/camera-sem-escrita.png"></img>
            </span>
          ...
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              ...
              <i class="fa fa-laptop fa-stack-1x fa-inverse"></i> -->
               <img class="img-fluid" alt="Responsive image"  src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/infraestrutura-sem-escrita.png"></img> 
            </span>
          ...
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              ...
              <img class="img-fluid" alt="Responsive image"  src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/alarmes-sem-escrita.png"></img>
            </span>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/01-rendicollaPQ.jpg" alt="">
            </a>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
              ...
              <img class="img-fluid" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/02-funerariadocarmoPQ.jpg" alt="">
            </a>
            <div class="portfolio-caption">
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
              ...
              <img class="img-fluid" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/03-SuperMercadoPalmeiraPQ.jpg" alt="">
            </a>
            <div class="portfolio-caption">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/logos/Intelbras.jpg" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/logos/LuxVision.jpg" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/logos/NTC.jpg" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
              <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/logos/PPA.jpg" alt="">
            </a>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/01-rendicollaGD.jpg" alt="">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/02-funerariadocarmoGD.jpg" alt="">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="http://<?php echo APP_HOST; ?>/App/Views/Site/img/clientes/03-SuperMercadoPalmeiraGD.jpg" alt="">
    ...
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/vendor/jquery/jquery.min.js"></script>
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Contact form JavaScript -->
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/js/jqBootstrapValidation.js"></script>
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/js/contact_me.js"></script>
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/js/tam_fonte.js"></script>

    <!-- Custom scripts for this template -->
    <script src="http://<?php echo APP_HOST; ?>/App/Views/Site/js/agency.min.js"></script>
